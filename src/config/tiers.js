...
export const TIER_CONFIG = {
  guest: {
    ...
    canRemoveQrBrand: false, hasCustomQr: false, hasBulkQr: false, maxBulkQrBatch: 0, maxDynamicQrPerMonth: 0, hasApi: false, monthlyApiLimit: 0,
  ...
  canRemoveQrBrand: true, hasCustomQr: false, hasBulkQr: false, maxBulkQrBatch: 0, maxDynamicQrPerMonth: 20, hasApi: false, monthlyApiLimit: 0,
  hasDataExport: false, hasCustomDomain: false,
  hasPixel: false, maxPixelPerLink: 0, maxPixelLinks: 0,
  hasABTest: false, maxABUrls: 0, maxABLinks: 0, hasCustomABPercent: false,
  hasDeepLink: false, hasSmartFallback: false,
  ...
  pro: {
    ...
    canRemoveQrBrand: true, hasCustomQr: true, hasBulkQr: true, maxBulkQrBatch: 50, maxDynamicQrPerMonth: 100, hasApi: true, monthlyApiLimit: 5000,
  ...
  super: {
    ...
    canRemoveQrBrand: true, hasCustomQr: true, hasBulkQr: true, maxBulkQrBatch: 200, maxDynamicQrPerMonth: 500, hasApi: true, monthlyApiLimit: 10000,
  ...
  admin: {
    ...
    canRemoveQrBrand: true, hasCustomQr: true, hasBulkQr: true, maxBulkQrBatch: 999999, maxDynamicQrPerMonth: 999999, hasApi: true, monthlyApiLimit: 999999,
    hasDataExport: true, hasCustomDomain: true,
